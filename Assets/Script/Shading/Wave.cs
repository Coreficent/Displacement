namespace Coreficent.Shading
{
    ...
    public class Wave
    {
        ...
        public readonly AnimationCurve Sine = new AnimationCurve(
            ...
            new Keyframe(0.3f, 1.00f, 0, 0),
            new Keyframe(0.4f, 0.50f, 0, 0),
            new Keyframe(0.5f, 1.00f, 0, 0),
            new Keyframe(0.6f, 0.50f, 0, 0),
            new Keyframe(0.7f, 1.00f, 0, 0),
            new Keyframe(0.8f, 0.50f, 0, 0),
            new Keyframe(0.9f, 1.00f, 0, 0),
        ...
        public readonly AnimationCurve Step = new AnimationCurve(
            ...
            new Keyframe(0.74f, 1.00f, 0, 0),
            new Keyframe(0.75f, 0.00f, 0, 0),
